...
<%
        ...
        try {
            ...
            ps=cn.prepareStatement("insert into FEEDBACKTABLE values(?,?)");
            String t1=request.getParameter("t1");
            String t2=(String)session.getAttribute("uname");
            ps.setString(1,t2);
            ps.setString(2,t1);
            int i=ps.executeUpdate();
            if(i==1)
                out.println("<h3 style='text-align:center'>Succesfully Reported</h3>");
            else
                out.println("<h3 style='text-align:center'>Not Succesfully Reported</h3>");
